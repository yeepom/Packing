...
class OrderSeparate(models.Model):
    everSetInfo = models.BooleanField(default=False)
...
ORDER_STATUS_CHOICES=(
    (u'0',u'处理中'),
    (u'2',u'待评价'),  #lockTableStyle为1时，无此状态
	(u'4',u'完成'),
)
...
class Order(models.Model):
    shopId = models.CharField('店铺Id',max_length=20,default='')
    waiterId = models.CharField('点菜员id',max_length=20,default='')
    ...
    userName = models.CharField('用户名字',max_length=20,default='')
...
class OrderSku(models.Model):
    ...
    categoryType = models.CharField('categoryType',max_length=20,default='0')
    tableId = models.CharField('餐桌id',max_length=20)
    tableNumber = models.CharField('餐桌号',max_length=100)
    ...
    orderSeparateId = models.CharField('配菜员id',max_length=20,default='')
    orderSeparateName = models.CharField('配菜员名字',max_length=20,default='')
    beforeCookId = models.CharField('前打荷id',max_length=20,default='')
    beforeCookName = models.CharField('前打荷名字',max_length=20,default='')
    cookId = models.CharField('厨师id',max_length=20,default='')
    cookName = models.CharField('厨师名字',max_length=20,default='')
    afterCookId = models.CharField('后打荷id',max_length=20,default='')
    afterCookName = models.CharField('后打荷名字',max_length=20,default='')
...
class OrderSeparateFeedBack(models.Model):
    orderSeparate = models.ForeignKey(OrderSeparate)
    msg = models.CharField('内容',max_length = 400)
    date = models.DateTimeField(default=datetime.now())

class BeforeCookFeedBack(models.Model):
    beforeCook = models.ForeignKey(BeforeCook)
    msg = models.CharField('内容',max_length = 400)
    date = models.DateTimeField(default=datetime.now())

class AfterCookFeedBack(models.Model):
    afterCook = models.ForeignKey(AfterCook)
    msg = models.CharField('内容',max_length = 400)
    date = models.DateTimeField(default=datetime.now())
