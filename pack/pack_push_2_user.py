...
APPID = "5annHdFcO97gFfOv58wzj"
APPKEY = "ydIoS4Chhp75vIQoV7qI59"
MASTERSECRET = "oPNkbPgvhp5JhwX2FegQY1"

CID = "1111"
HOST = 'http://sdk.open.api.igexin.com/apiex.htm'
DEVICETOKEN = ""

def pushAPNToUser(deviceToken,type, orderId):
    ...
    if type == '100':
        template.setPushInfo("查看",0,"您的订单待支付","",_payLoad,"","","",1)
...
def pushMessageToSingle(clientID,type,data):
    push = IGeTui(HOST, APPKEY, MASTERSECRET)
    #消息模版：
...
def TransmissionTemplateDemo(type,data):
    ...
    #iOS 推送需要的PushInfo字段 前三项必填，后四项可以填空字符串
    #template.setPushInfo(actionLocKey, badge, message, sound, payload, locKey, locArgs, launchImage)
    #template.setPushInfo("actionLocKey",1,"这是一条消息","","{payLoad:1}","","","",1)
    return template
