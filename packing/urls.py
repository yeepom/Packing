...
urlpatterns = patterns('',
    ...
    url(r'^addServesToCategory$','pack.shop_sku_serve.addServesToCategory'),
    url(r'^getServesInCategory$','pack.shop_sku_serve.getServesInCategory'),
    url(r'^getFreeServeList$','pack.shop_sku_serve.getFreeServeList'),
    url(r'^removeServeInCategory$','pack.shop_sku_serve.removeServeInCategory'),
